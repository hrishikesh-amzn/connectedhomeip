...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0034, ZAP_ATTRIBUTE_INDEX(117), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Do Something Cluster (server) */ \
...
#define ATTRIBUTE_MAX_SIZE (6822)
...
#define EMBER_AF_GENERATED_COMMAND_COUNT (118)
