...
#define EMBER_AF_DO_SOMETHING_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Do Something Cluster cluster is included
#define ZCL_USING_DO_SOMETHING_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_DO_SOMETHING_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_DO_SOMETHING_CLUSTER
