...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0034, ZAP_ATTRIBUTE_INDEX(21), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Do Something Cluster (server) */ \
  { 0x0035, ZAP_ATTRIBUTE_INDEX(22), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */ \
  { 0x0036, ZAP_ATTRIBUTE_INDEX(83), 6, 13, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0037, ZAP_ATTRIBUTE_INDEX(89), 6, 42, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(95), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0200, ZAP_ATTRIBUTE_INDEX(97), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Pump Configuration and Control (client) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(98), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (client) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(99), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (client) */ \
...
#define ATTRIBUTE_MAX_SIZE (1590)
