...
void emberAfClusterInitCallback(EndpointId endpoint, ClusterId clusterId)
{
    switch (clusterId)
    {
     ...
     case ZCL_DIAGNOSTIC_LOGS_CLUSTER_ID :
        ...
        break;
     case ZCL_DO_SOMETHING_CLUSTER_ID :
        emberAfDoSomethingClusterClusterInitCallback(endpoint);
        break;
...
void __attribute__((weak)) emberAfDoSomethingClusterClusterInitCallback(EndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
