...
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1067 - TxBroadcastCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1071 - TxAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1075 - TxAckedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1079 - TxNoAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1083 - TxDataCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1087 - TxDataPollCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1091 - TxBeaconCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1095 - TxBeaconRequestCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1099 - TxOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1107 - TxDirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1111 - TxIndirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1115 - TxErrCcaCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1119 - TxErrAbortCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1123 - TxErrBusyChannelCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1127 - RxTotalCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1135 - RxBroadcastCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1139 - RxDataCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1143 - RxDataPollCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1147 - RxBeaconCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1151 - RxBeaconRequestCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1155 - RxOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1159 - RxAddressFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1163 - RxDestAddrFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1167 - RxDuplicatedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1171 - RxErrNoFrameCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1175 - RxErrUnknownNeighborCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1179 - RxErrInvalidSrcAddrCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1183 - RxErrSecCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1191 - RxErrOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1195 - SecurityPolicy, */\
  0x00, 0x00, 0x00, 0x00, 0x00, \
\
  /* 1200 - OperationalDatasetComponents, */\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
\
  /* 1214 - ActiveNetworkFaultsList, */\
  0x00, 0x00, 0x00, 0x00, \
\
\
...
\
  ...
  { 0x0002, ZAP_TYPE(OCTET_STRING), 16, 0, ZAP_LONG_DEFAULTS_INDEX(498) }, /* NetworkName */  \
  { 0x0003, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* PanId */  \
  { 0x0004, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(514) }, /* ExtendedPanId */  \
  { 0x0005, ZAP_TYPE(OCTET_STRING), 17, 0, ZAP_LONG_DEFAULTS_INDEX(522) }, /* MeshLocalPrefix */  \
  { 0x0006, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(539) }, /* OverrunCount */  \
  { 0x0007, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(547) }, /* NeighborTableList */  \
  { 0x0008, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(801) }, /* RouteTableList */  \
  { 0x0009, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1055) }, /* PartitionId */  \
  ...
  { 0x0016, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1059) }, /* TxTotalCount */  \
  { 0x0017, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1063) }, /* TxUnicastCount */  \
  { 0x0018, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1067) }, /* TxBroadcastCount */  \
  { 0x0019, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1071) }, /* TxAckRequestedCount */  \
  { 0x001A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1075) }, /* TxAckedCount */  \
  { 0x001B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1079) }, /* TxNoAckRequestedCount */  \
  { 0x001C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1083) }, /* TxDataCount */  \
  { 0x001D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1087) }, /* TxDataPollCount */  \
  { 0x001E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1091) }, /* TxBeaconCount */  \
  { 0x001F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1095) }, /* TxBeaconRequestCount */  \
  { 0x0020, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1099) }, /* TxOtherCount */  \
  { 0x0021, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1103) }, /* TxRetryCount */  \
  { 0x0022, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1107) }, /* TxDirectMaxRetryExpiryCount */  \
  { 0x0023, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1111) }, /* TxIndirectMaxRetryExpiryCount */  \
  { 0x0024, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1115) }, /* TxErrCcaCount */  \
  { 0x0025, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1119) }, /* TxErrAbortCount */  \
  { 0x0026, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1123) }, /* TxErrBusyChannelCount */  \
  { 0x0027, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1127) }, /* RxTotalCount */  \
  { 0x0028, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1131) }, /* RxUnicastCount */  \
  { 0x0029, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1135) }, /* RxBroadcastCount */  \
  { 0x002A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1139) }, /* RxDataCount */  \
  { 0x002B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1143) }, /* RxDataPollCount */  \
  { 0x002C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1147) }, /* RxBeaconCount */  \
  { 0x002D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1151) }, /* RxBeaconRequestCount */  \
  { 0x002E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1155) }, /* RxOtherCount */  \
  { 0x002F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1159) }, /* RxAddressFilteredCount */  \
  { 0x0030, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1163) }, /* RxDestAddrFilteredCount */  \
  { 0x0031, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1167) }, /* RxDuplicatedCount */  \
  { 0x0032, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1171) }, /* RxErrNoFrameCount */  \
  { 0x0033, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1175) }, /* RxErrUnknownNeighborCount */  \
  { 0x0034, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1179) }, /* RxErrInvalidSrcAddrCount */  \
  { 0x0035, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1183) }, /* RxErrSecCount */  \
  { 0x0036, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1187) }, /* RxErrFcsCount */  \
  { 0x0037, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1191) }, /* RxErrOtherCount */  \
  { 0x003B, ZAP_TYPE(ARRAY), 5, 0, ZAP_LONG_DEFAULTS_INDEX(1195) }, /* SecurityPolicy */  \
  { 0x003C, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* ChannelMask */  \
  { 0x003D, ZAP_TYPE(ARRAY), 14, 0, ZAP_LONG_DEFAULTS_INDEX(1200) }, /* OperationalDatasetComponents */  \
  { 0x003E, ZAP_TYPE(ARRAY), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1214) }, /* ActiveNetworkFaultsList */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
  /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0000, ZAP_TYPE(OCTET_STRING), 6, 0, ZAP_LONG_DEFAULTS_INDEX(1218) }, /* bssid */  \
...
\
  ...
  { 0x0002, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1224) }, /* PacketRxCount */  \
  { 0x0003, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1232) }, /* PacketTxCount */  \
  { 0x0004, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1240) }, /* TxErrCount */  \
  { 0x0005, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1248) }, /* CollisionCount */  \
  { 0x0006, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1256) }, /* OverrunCount */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
  /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1264) }, /* fabrics list */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0034, ZAP_ATTRIBUTE_INDEX(23), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Do Something Cluster (server) */ \
  { 0x0035, ZAP_ATTRIBUTE_INDEX(24), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */ \
  { 0x0036, ZAP_ATTRIBUTE_INDEX(85), 6, 13, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0037, ZAP_ATTRIBUTE_INDEX(91), 6, 42, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(97), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0200, ZAP_ATTRIBUTE_INDEX(99), 8, 13, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(ATTRIBUTE_CHANGED_FUNCTION), chipFuncArrayPumpConfigurationAndControlServer }, /* Endpoint: 1, Cluster: Pump Configuration and Control (server) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(107), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (client) */ \
  { 0x0402, ZAP_ATTRIBUTE_INDEX(108), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(112), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (client) */ \
  { 0x0403, ZAP_ATTRIBUTE_INDEX(113), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Pressure Measurement (server) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(117), 1, 2, ZAP_CLUSTER_MASK(CLIENT), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (client) */ \
  { 0x0404, ZAP_ATTRIBUTE_INDEX(118), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Flow Measurement (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (1627)
