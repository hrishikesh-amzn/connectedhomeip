...
public:
    ...
    void AddReportCallbacks(uint8_t endpointId) override
    {
        ...
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0406, 0x0000, onReportOccupancySensingOccupancyCallback->Cancel());
        ...
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x0008, onReportWindowCoveringCurrentPositionLiftPercentageCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x0009, onReportWindowCoveringCurrentPositionTiltPercentageCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x000A, onReportWindowCoveringOperationalStatusCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x000B, onReportWindowCoveringTargetPositionLiftPercent100thsCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x000C, onReportWindowCoveringTargetPositionTiltPercent100thsCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x000E, onReportWindowCoveringCurrentPositionLiftPercent100thsCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x000F, onReportWindowCoveringCurrentPositionTiltPercent100thsCallback->Cancel());
        callbacksMgr.AddReportCallback(chip::kTestDeviceNodeId, endpointId, 0x0102, 0x001A, onReportWindowCoveringSafetyStatusCallback->Cancel());
    }
