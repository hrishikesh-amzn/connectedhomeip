...
static void OnDoSomethingClusterClusterDoSomethingResponse(void * context, uint8_t * data)
{
    ChipLogProgress(chipTool, "DoSomethingClusterClusterDoSomethingResponse");
...
constexpr chip::ClusterId kDoSomethingClusterClusterId = 0x0034;
...
/*----------------------------------------------------------------------------*\
| Cluster DoSomethingCluster                                          | 0x0034 |
|------------------------------------------------------------------------------|
| Commands:                                                           |        |
| * DoSomething                                                       |   0x00 |
|------------------------------------------------------------------------------|
 ...
 * Command DoSomething
 */
class DoSomethingClusterDoSomething: public ModelCommand
{
public:
    DoSomethingClusterDoSomething(): ModelCommand("do-something")
    {
        AddArgument("Data", &mData);
        ModelCommand::AddArguments();
    }
    ~DoSomethingClusterDoSomething()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
    ...
    CHIP_ERROR SendCommand(ChipDevice * device, uint8_t endpointId) override
    {
        ...
        chip::Controller::DoSomethingClusterCluster cluster;
        cluster.Associate(device, endpointId);
        return cluster.DoSomething(onSuccessCallback->Cancel(), onFailureCallback->Cancel(),  chip::ByteSpan(chip::Uint8::from_char(mData), strlen(mData)));
    }

private:
    chip::Callback::Callback<DoSomethingClusterClusterDoSomethingResponseCallback> * onSuccessCallback = new chip::Callback::Callback<DoSomethingClusterClusterDoSomethingResponseCallback>(OnDoSomethingClusterClusterDoSomethingResponse, this);
    chip::Callback::Callback<DefaultFailureCallback> * onFailureCallback = new chip::Callback::Callback<DefaultFailureCallback>(OnDefaultFailureResponse, this);
    char * mData;
};
 ...
 * Discover Attributes
 */
class DiscoverDoSomethingClusterAttributes: public ModelCommand
{
public:
    DiscoverDoSomethingClusterAttributes(): ModelCommand("discover")
    {
        ModelCommand::AddArguments();
    }

    ~DiscoverDoSomethingClusterAttributes()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
 ...
 * Attribute ClusterRevision
 */
class ReadDoSomethingClusterClusterRevision: public ModelCommand
{
public:
    ReadDoSomethingClusterClusterRevision(): ModelCommand("read")
    {
        AddArgument("attr-name", "cluster-revision");
        ModelCommand::AddArguments();
    }

    ~ReadDoSomethingClusterClusterRevision()
    {
      delete onSuccessCallback;
      delete onFailureCallback;
    }
...
void registerClusterDoSomethingCluster(Commands & commands)
{
    const char * clusterName = "DoSomethingCluster";

    commands_list clusterCommands = {
        make_unique<DoSomethingClusterDoSomething>(),
        make_unique<DiscoverDoSomethingClusterAttributes>(),
        make_unique<ReadDoSomethingClusterClusterRevision>(),
    };
...
void registerClusters(Commands & commands)
{
    ...
    registerClusterDoSomethingCluster(commands);
