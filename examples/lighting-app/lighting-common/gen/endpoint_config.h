...
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1467 - TxBroadcastCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1471 - TxAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1475 - TxAckedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1479 - TxNoAckRequestedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1483 - TxDataCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1487 - TxDataPollCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1491 - TxBeaconCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1495 - TxBeaconRequestCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1499 - TxOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1507 - TxDirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1511 - TxIndirectMaxRetryExpiryCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1515 - TxErrCcaCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1519 - TxErrAbortCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1523 - TxErrBusyChannelCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1527 - RxTotalCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1535 - RxBroadcastCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1539 - RxDataCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1543 - RxDataPollCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1547 - RxBeaconCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1551 - RxBeaconRequestCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1555 - RxOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1559 - RxAddressFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1563 - RxDestAddrFilteredCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1567 - RxDuplicatedCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1571 - RxErrNoFrameCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1575 - RxErrUnknownNeighborCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1579 - RxErrInvalidSrcAddrCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1583 - RxErrSecCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  ...
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1591 - RxErrOtherCount, */\
  0x00, 0x00, 0x00, 0x00, \
\
  /* 1595 - SecurityPolicy, */\
  0x00, 0x00, 0x00, 0x00, 0x00, \
\
  /* 1600 - OperationalDatasetComponents, */\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
\
  /* 1614 - ActiveNetworkFaultsList, */\
  0x00, 0x00, 0x00, 0x00, \
\
\
...
\
  ...
  { 0x0002, ZAP_TYPE(OCTET_STRING), 16, 0, ZAP_LONG_DEFAULTS_INDEX(898) }, /* NetworkName */  \
  { 0x0003, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* PanId */  \
  { 0x0004, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(914) }, /* ExtendedPanId */  \
  { 0x0005, ZAP_TYPE(OCTET_STRING), 17, 0, ZAP_LONG_DEFAULTS_INDEX(922) }, /* MeshLocalPrefix */  \
  { 0x0006, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(939) }, /* OverrunCount */  \
  { 0x0007, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(947) }, /* NeighborTableList */  \
  { 0x0008, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1201) }, /* RouteTableList */  \
  { 0x0009, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1455) }, /* PartitionId */  \
  ...
  { 0x0016, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1459) }, /* TxTotalCount */  \
  { 0x0017, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1463) }, /* TxUnicastCount */  \
  { 0x0018, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1467) }, /* TxBroadcastCount */  \
  { 0x0019, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1471) }, /* TxAckRequestedCount */  \
  { 0x001A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1475) }, /* TxAckedCount */  \
  { 0x001B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1479) }, /* TxNoAckRequestedCount */  \
  { 0x001C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1483) }, /* TxDataCount */  \
  { 0x001D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1487) }, /* TxDataPollCount */  \
  { 0x001E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1491) }, /* TxBeaconCount */  \
  { 0x001F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1495) }, /* TxBeaconRequestCount */  \
  { 0x0020, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1499) }, /* TxOtherCount */  \
  { 0x0021, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1503) }, /* TxRetryCount */  \
  { 0x0022, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1507) }, /* TxDirectMaxRetryExpiryCount */  \
  { 0x0023, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1511) }, /* TxIndirectMaxRetryExpiryCount */  \
  { 0x0024, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1515) }, /* TxErrCcaCount */  \
  { 0x0025, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1519) }, /* TxErrAbortCount */  \
  { 0x0026, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1523) }, /* TxErrBusyChannelCount */  \
  { 0x0027, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1527) }, /* RxTotalCount */  \
  { 0x0028, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1531) }, /* RxUnicastCount */  \
  { 0x0029, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1535) }, /* RxBroadcastCount */  \
  { 0x002A, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1539) }, /* RxDataCount */  \
  { 0x002B, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1543) }, /* RxDataPollCount */  \
  { 0x002C, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1547) }, /* RxBeaconCount */  \
  { 0x002D, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1551) }, /* RxBeaconRequestCount */  \
  { 0x002E, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1555) }, /* RxOtherCount */  \
  { 0x002F, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1559) }, /* RxAddressFilteredCount */  \
  { 0x0030, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1563) }, /* RxDestAddrFilteredCount */  \
  { 0x0031, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1567) }, /* RxDuplicatedCount */  \
  { 0x0032, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1571) }, /* RxErrNoFrameCount */  \
  { 0x0033, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1575) }, /* RxErrUnknownNeighborCount */  \
  { 0x0034, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1579) }, /* RxErrInvalidSrcAddrCount */  \
  { 0x0035, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1583) }, /* RxErrSecCount */  \
  { 0x0036, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1587) }, /* RxErrFcsCount */  \
  { 0x0037, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1591) }, /* RxErrOtherCount */  \
  { 0x003B, ZAP_TYPE(ARRAY), 5, 0, ZAP_LONG_DEFAULTS_INDEX(1595) }, /* SecurityPolicy */  \
  { 0x003C, ZAP_TYPE(INT8U), 1, 0, ZAP_SIMPLE_DEFAULT(0x0000) }, /* ChannelMask */  \
  { 0x003D, ZAP_TYPE(ARRAY), 14, 0, ZAP_LONG_DEFAULTS_INDEX(1600) }, /* OperationalDatasetComponents */  \
  { 0x003E, ZAP_TYPE(ARRAY), 4, 0, ZAP_LONG_DEFAULTS_INDEX(1614) }, /* ActiveNetworkFaultsList */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
  /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0000, ZAP_TYPE(OCTET_STRING), 6, 0, ZAP_LONG_DEFAULTS_INDEX(1618) }, /* bssid */  \
...
\
  ...
  { 0x0002, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1624) }, /* PacketRxCount */  \
  { 0x0003, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1632) }, /* PacketTxCount */  \
  { 0x0004, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1640) }, /* TxErrCount */  \
  { 0x0005, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1648) }, /* CollisionCount */  \
  { 0x0006, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(1656) }, /* OverrunCount */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
  /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1664) }, /* fabrics list */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */  \
\
...
#define GENERATED_CLUSTERS { \
  ...
  { 0x0034, ZAP_ATTRIBUTE_INDEX(26), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Do Something Cluster (server) */ \
  { 0x0035, ZAP_ATTRIBUTE_INDEX(27), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Thread Network Diagnostics (server) */ \
  { 0x0036, ZAP_ATTRIBUTE_INDEX(88), 6, 13, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: WiFi Network Diagnostics (server) */ \
  { 0x0037, ZAP_ATTRIBUTE_INDEX(94), 6, 42, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */ \
  { 0x003E, ZAP_ATTRIBUTE_INDEX(100), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(102), 6, 9, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 1, Cluster: On/off (server) */ \
  { 0x0008, ZAP_ATTRIBUTE_INDEX(108), 5, 7, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayLevelControlServer }, /* Endpoint: 1, Cluster: Level Control (server) */ \
  { 0x0300, ZAP_ATTRIBUTE_INDEX(113), 22, 36, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayColorControlServer }, /* Endpoint: 1, Cluster: Color Control (server) */ \
  { 0x0406, ZAP_ATTRIBUTE_INDEX(135), 4, 5, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOccupancySensingServer }, /* Endpoint: 1, Cluster: Occupancy Sensing (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (2037)
