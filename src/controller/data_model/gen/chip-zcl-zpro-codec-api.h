...
/**
 * @brief
 *    Encode a Do Something Cluster server discover command into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeDoSomethingClusterClusterDiscoverAttributes(uint8_t seqNum, chip::EndpointId destinationEndpoint);

/**
 * @brief
 *    Encode a Do Something Cluster server read command for the cluster revision attribute into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeDoSomethingClusterClusterReadClusterRevisionAttribute(uint8_t seqNum, chip::EndpointId destinationEndpoint);
