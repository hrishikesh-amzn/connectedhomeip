...
constexpr ClusterId kDoSomethingClusterClusterId = 0x0034;
...
class DLL_EXPORT DoSomethingClusterCluster : public ClusterBase
{
public:
    DoSomethingClusterCluster() : ClusterBase(kDoSomethingClusterClusterId) {}
    ~DoSomethingClusterCluster() {}

    // Cluster Commands
    CHIP_ERROR DoSomething(Callback::Cancelable * onSuccessCallback, Callback::Cancelable * onFailureCallback, chip::ByteSpan data);
...
private:
    static constexpr CommandId kDoSomethingCommandId = 0x00;
};
