...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfApplicationLauncherClusterLaunchAppResponseCallback(apCommandObj, status, const_cast<uint8_t*>(data));
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfContentLauncherClusterLaunchContentResponseCallback(apCommandObj, const_cast<uint8_t*>(data), contentLaunchStatus);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfContentLauncherClusterLaunchURLResponseCallback(apCommandObj, const_cast<uint8_t*>(data), contentLaunchStatus);
        }
            break;
        }
        default: {
...
void DispatchClientCommand(app::Command * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled = false;
    {
        switch (aCommandId)
        {
        case Clusters::DoSomethingCluster::Commands::Ids::DoSomethingResponse: {
        expectArgumentCount = 1;
const uint8_t * data;
bool argExists[1];
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoSomethingClusterClusterDoSomethingResponseCallback(apCommandObj, const_cast<uint8_t*>(data));
        }
            break;
        }
        default: {
            ...
            chip::app::CommandPathParams returnStatusParam = { aEndpointId,
                                                       0, // GroupId
                                                       Clusters::DoSomethingCluster::Id,
                                                       aCommandId,
                                                       (chip::app::CommandPathFlags::kEndpointIdValid) };
            apCommandObj->AddStatusCode(returnStatusParam, Protocols::SecureChannel::GeneralStatusCode::kNotFound, Protocols::SecureChannel::Id,
        Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
            ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32, aCommandId, Clusters::DoSomethingCluster::Id);
            return;
        }
        }
    }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetHolidayScheduleResponseCallback(apCommandObj, scheduleId, status, localStartTime, localEndTime, operatingModeDuringHoliday);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetLogRecordResponseCallback(apCommandObj, logEntryId, timestamp, eventType, source, eventIdOrAlarmCode, userId, const_cast<uint8_t*>(pin));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetPinResponseCallback(apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(pin));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetRfidResponseCallback(apCommandObj, userId, userStatus, userType, const_cast<uint8_t*>(rfid));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetWeekdayScheduleResponseCallback(apCommandObj, scheduleId, userId, status, daysMask, startHour, startMinute, endHour, endMinute);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfDoorLockClusterGetYeardayScheduleResponseCallback(apCommandObj, scheduleId, userId, status, localStartTime, localEndTime);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfGeneralCommissioningClusterArmFailSafeResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfGeneralCommissioningClusterCommissioningCompleteResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfGeneralCommissioningClusterSetRegulatoryConfigResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfGroupsClusterViewGroupResponseCallback(apCommandObj, status, groupId, const_cast<uint8_t*>(groupName));
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterAddThreadNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterAddWiFiNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterDisableNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterEnableNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterRemoveNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterScanNetworksResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText), wifiScanResults, threadScanResults);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterUpdateThreadNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfNetworkCommissioningClusterUpdateWiFiNetworkResponseCallback(apCommandObj, errorCode, const_cast<uint8_t*>(debugText));
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateProviderClusterApplyUpdateRequestResponseCallback(apCommandObj, action, delayedActionTime);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOtaSoftwareUpdateProviderClusterQueryImageResponseCallback(apCommandObj, status, delayedActionTime, const_cast<uint8_t*>(imageURI), softwareVersion, updateToken, userConsentNeeded, metadataForRequestor);
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOperationalCredentialsClusterOpCSRResponseCallback(apCommandObj, CSR, CSRNonce, VendorReserved1, VendorReserved2, VendorReserved3, Signature);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfOperationalCredentialsClusterOpCertResponseCallback(apCommandObj, StatusCode, FabricIndex, const_cast<uint8_t*>(DebugText));
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfScenesClusterGetSceneMembershipResponseCallback(apCommandObj, status, capacity, groupId, sceneCount, sceneList);
        }
            break;
        }
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfScenesClusterViewSceneResponseCallback(apCommandObj, status, groupId, sceneId, transitionTime, const_cast<uint8_t*>(sceneName), extensionFieldSets);
        }
            break;
        }
        default: {
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        wasHandled = emberAfTargetNavigatorClusterNavigateTargetResponseCallback(apCommandObj, status, const_cast<uint8_t*>(data));
        }
            break;
        }
        default: {
                             ...
                             chip::TLV::TLVReader & aReader, Command * apCommandObj)
{
    ...
    case Clusters::ContentLauncher::Id:
        ...
        break;
    case Clusters::DoSomethingCluster::Id:
        clusters::DoSomethingCluster::DispatchClientCommand(apCommandObj, aCommandId, aEndPointId, aReader);
        break;
