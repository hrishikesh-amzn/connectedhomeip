...
#define EMBER_AF_DO_SOMETHING_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
// Use this macro to check if the client side of the Do Something Cluster cluster is included
#define ZCL_USING_DO_SOMETHING_CLUSTER_CLIENT
#define EMBER_AF_PLUGIN_DO_SOMETHING_CLUSTER_CLIENT
