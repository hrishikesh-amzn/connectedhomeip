...
PacketBufferHandle encodeDoSomethingClusterClusterDiscoverAttributes(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("DiscoverDoSomethingClusterAttributes", DoSomethingCluster::Id);
    buf.Put8(kFrameControlGlobalCommand)
       .Put8(seqNum)
       .Put32(Globals::Commands::Ids::DiscoverAttributes)
       .Put32(0x0000)
 ...
 * Attribute ClusterRevision
 */
PacketBufferHandle encodeDoSomethingClusterClusterReadClusterRevisionAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadDoSomethingClusterClusterRevision", DoSomethingCluster::Id);
    buf.Put8(kFrameControlGlobalCommand)
       .Put8(seqNum)
       .Put32(Globals::Commands::Ids::ReadAttributes)
       .Put32(Globals::Attributes::Ids::ClusterRevision);
