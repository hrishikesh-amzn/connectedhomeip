...
class CHIPDoSomethingClusterClusterDoSomethingResponseCallback : public Callback::Callback<DoSomethingClusterClusterDoSomethingResponseCallback>
{
    public:
        CHIPDoSomethingClusterClusterDoSomethingResponseCallback(jobject javaCallback): Callback::Callback<DoSomethingClusterClusterDoSomethingResponseCallback>(CallbackFn, this)
        {
            JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
            if (env == nullptr) {
                ChipLogError(Zcl, "Could not create global reference for Java callback");
        ...
        ~CHIPDoSomethingClusterClusterDoSomethingResponseCallback()
        {
            JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
            if (env == nullptr) {
                ChipLogError(Zcl, "Could not create global reference for Java callback");
        ...
        static void CallbackFn(void * context, uint8_t * data)
        {
            ...
            jobject javaCallbackRef;
            jmethodID javaMethod;
            CHIPDoSomethingClusterClusterDoSomethingResponseCallback * cppCallback = nullptr;
            // ByteSpan is not properly returned yet, temporarily use empty string
            UtfString dataStr(env, "");
            
            VerifyOrExit(env != nullptr, err = CHIP_JNI_ERROR_NO_ENV);

            cppCallback = reinterpret_cast<CHIPDoSomethingClusterClusterDoSomethingResponseCallback *>(context);
            VerifyOrExit(cppCallback != nullptr, err = CHIP_JNI_ERROR_NULL_OBJECT);
...
{
    public:
        CHIPMediaPlaybackClusterMediaSeekResponseCallback(jobject javaCallback): Callback::Callback<MediaPlaybackClusterMediaSeekResponseCallback>(CallbackFn, this)
        {
            JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
            if (env == nullptr) {
                ChipLogError(Zcl, "Could not create global reference for Java callback");
...
class CHIPOtaSoftwareUpdateProviderClusterApplyUpdateRequestResponseCallback : public Callback::Callback<OtaSoftwareUpdateProviderClusterApplyUpdateRequestResponseCallback>
{
    public:
        CHIPOtaSoftwareUpdateProviderClusterApplyUpdateRequestResponseCallback(jobject javaCallback): Callback::Callback<OtaSoftwareUpdateProviderClusterApplyUpdateRequestResponseCallback>(CallbackFn, this)
        {
            JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
            if (env == nullptr) {
                ChipLogError(Zcl, "Could not create global reference for Java callback");
...
class CHIPOtaSoftwareUpdateProviderClusterQueryImageResponseCallback : public Callback::Callback<OtaSoftwareUpdateProviderClusterQueryImageResponseCallback>
{
    public:
        CHIPOtaSoftwareUpdateProviderClusterQueryImageResponseCallback(jobject javaCallback): Callback::Callback<OtaSoftwareUpdateProviderClusterQueryImageResponseCallback>(CallbackFn, this)
        {
            JNIEnv * env = JniReferences::GetInstance().GetEnvForCurrentThread();
            if (env == nullptr) {
                ChipLogError(Zcl, "Could not create global reference for Java callback");
        ...
        static void CallbackFn(void * context, uint32_t delayedActionTime, uint8_t * imageURI, uint32_t softwareVersion, chip::ByteSpan updateToken, uint8_t userConsentNeeded, chip::ByteSpan metadataForRequestor)
        {
            ...
            env->ExceptionClear();
            env->SetByteArrayRegion(metadataForRequestorArr, 0, metadataForRequestor.size(), reinterpret_cast<const jbyte *>(metadataForRequestor.data()));
            VerifyOrExit(!env->ExceptionCheck(), err = CHIP_JNI_ERROR_EXCEPTION_THROWN);
...
JNI_METHOD(void, BindingCluster, bind)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jlong nodeId, jint groupId, jint endpointId, jlong clusterId)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
...
JNI_METHOD(void, BindingCluster, unbind)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jlong nodeId, jint groupId, jint endpointId, jlong clusterId)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    BindingCluster * cppCluster;
...
JNI_METHOD(void, ColorControlCluster, colorLoopSet)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint updateFlags, jint action, jint direction, jint time, jint startHue, jint optionsMask, jint optionsOverride)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
...
JNI_METHOD(void, ColorControlCluster, enhancedMoveHue)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint moveMode, jint rate, jint optionsMask, jint optionsOverride)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    ColorControlCluster * cppCluster;
...
JNI_METHOD(void, ColorControlCluster, enhancedMoveToHue)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint enhancedHue, jint direction, jint transitionTime, jint optionsMask, jint optionsOverride)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    ColorControlCluster * cppCluster;
...
JNI_METHOD(void, ColorControlCluster, enhancedMoveToHueAndSaturation)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint enhancedHue, jint saturation, jint transitionTime, jint optionsMask, jint optionsOverride)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    ColorControlCluster * cppCluster;
    ...
    err = cppCluster->EnhancedMoveToHueAndSaturation(onSuccess->Cancel(), onFailure->Cancel(), enhancedHue, saturation, transitionTime, optionsMask, optionsOverride);
    SuccessOrExit(err);
...
JNI_METHOD(void, ColorControlCluster, enhancedStepHue)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint stepMode, jint stepSize, jint transitionTime, jint optionsMask, jint optionsOverride)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    ColorControlCluster * cppCluster;
...
JNI_METHOD(jlong, DoSomethingClusterCluster, initWithDevice)(JNIEnv * env, jobject self, jlong devicePtr, jint endpointId)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    DoSomethingClusterCluster * cppCluster = new DoSomethingClusterCluster();

    cppCluster->Associate(reinterpret_cast<Device *>(devicePtr), endpointId);
    return reinterpret_cast<jlong>(cppCluster);
}

JNI_METHOD(void, DoSomethingClusterCluster, doSomething)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jstring data)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    DoSomethingClusterCluster * cppCluster;
    
    JniUtfString dataStr(env, data);
        CHIPDoSomethingClusterClusterDoSomethingResponseCallback * onSuccess;
    CHIPDefaultFailureCallback * onFailure;

    cppCluster = reinterpret_cast<DoSomethingClusterCluster *>(clusterPtr);
    VerifyOrExit(cppCluster != nullptr, err = CHIP_ERROR_INCORRECT_STATE);

    onSuccess = new CHIPDoSomethingClusterClusterDoSomethingResponseCallback(callback);
    VerifyOrExit(onSuccess != nullptr, err = CHIP_ERROR_INCORRECT_STATE);
    onFailure = new CHIPDefaultFailureCallback(callback);
    VerifyOrExit(onFailure != nullptr, err = CHIP_ERROR_INCORRECT_STATE);

    err = cppCluster->DoSomething(onSuccess->Cancel(), onFailure->Cancel(), chip::ByteSpan((const uint8_t*) data, strlen(dataStr.c_str())));
    SuccessOrExit(err);
...
JNI_METHOD(void, OtaSoftwareUpdateProviderCluster, applyUpdateRequest)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jbyteArray updateToken, jlong newVersion)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
...
JNI_METHOD(void, OtaSoftwareUpdateProviderCluster, notifyUpdateApplied)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jbyteArray updateToken, jlong currentVersion)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    OtaSoftwareUpdateProviderCluster * cppCluster;
...
JNI_METHOD(void, OtaSoftwareUpdateProviderCluster, queryImage)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint vendorId, jint productId, jint imageType, jint hardwareVersion, jlong currentVersion, jint protocolsSupported, jstring location, jint requestorCanConsent, jbyteArray metadataForProvider)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    OtaSoftwareUpdateProviderCluster * cppCluster;
...
JNI_METHOD(void, OperationalCredentialsCluster, addOpCert)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jbyteArray nOCArray, jbyteArray iPKValue, jlong caseAdminNode, jint adminVendorId)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
    ...
    err = cppCluster->AddOpCert(onSuccess->Cancel(), onFailure->Cancel(), chip::ByteSpan((const uint8_t*) nOCArrayArr.data(), nOCArrayArr.size()), chip::ByteSpan((const uint8_t*) iPKValueArr.data(), iPKValueArr.size()), caseAdminNode, adminVendorId);
    SuccessOrExit(err);
...
JNI_METHOD(void, ScenesCluster, addScene)(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jint groupId, jint sceneId, jint transitionTime, jstring sceneName, jlong clusterId, jint length, jint value)
{
    StackLockGuard lock(JniReferences::GetInstance().GetStackLock());
    CHIP_ERROR err = CHIP_NO_ERROR;
