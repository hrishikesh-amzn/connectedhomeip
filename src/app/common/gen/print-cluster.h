...
#if defined(ZCL_USING_DO_SOMETHING_CLUSTER_SERVER) || defined(ZCL_USING_DO_SOMETHING_CLUSTER_CLIENT)
    #define CHIP_PRINTCLUSTER_DO_SOMETHING_CLUSTER {ZCL_DO_SOMETHING_CLUSTER_ID, 52, "Do Something Cluster" },
#else
    #define CHIP_PRINTCLUSTER_DO_SOMETHING_CLUSTER
#endif
...
#define CLUSTER_IDS_TO_NAMES \
    ...
    CHIP_PRINTCLUSTER_DO_SOMETHING_CLUSTER \
